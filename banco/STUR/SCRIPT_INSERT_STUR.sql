	...
	INSERT INTO public.stur(
	 inscricao, tipoimposto, parcela, valortotal, cpfcnpj, endereco, cep, municipio, uf, numero)
	VALUES ( '500200', 'IPTU',500.00,2.000,'22222222222','Qs 22 conunto 300', '77777777','Bom Destino','MG','505 C');
	
	INSERT INTO public.stur(
	 inscricao, tipoimposto, parcela, valortotal, cpfcnpj, endereco, cep, municipio, uf, numero)
	VALUES ( '600300', 'IPTU',250.00,1.000,'22222222222','Qs 55 conunto 10', '77777999','Bom Destino','MG','998');
	
	INSERT INTO public.stur(
	 inscricao, tipoimposto, parcela, valortotal, cpfcnpj, endereco, cep, municipio, uf, numero)
	VALUES ( '500200', 'IPTU',2000.00,8.000,'33333333333333','Qs 31 setor de fabricas', '88999555','Bom Destino','MG','55');
	
	INSERT INTO public.stur(
	 inscricao, tipoimposto, parcela, valortotal, cpfcnpj, endereco, cep, municipio, uf, numero)
	VALUES ( '600300', 'IPTU',2500.00,10.000,'33333333333333','Qs 55 setor de fabricas', '88999555','Bom Destino','MG','56');
